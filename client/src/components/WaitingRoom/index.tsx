...
import { ConnectedPlayersContext, GameContext } from '../Room';
...
const WaitingRoom = () => {
  ...
  const username = getMyPlayer(gamePlayers, socket?.id)?.username;
  ...
  const isAdmin = isRoomAdmin(gamePlayers, socket.id);
